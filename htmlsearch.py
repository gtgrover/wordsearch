	...
	for liney in words:
		...
		for letterx in liney:
			if letterx == ' ':
				...
				print('<button style="height:30px;width:30px" type="button">'+ALPHA_HTML[ord(letterx)-65]+'</button>',end='')	
	print('</pre>')
...
def main():
	...
	word_list.append("RAT")
	word_list.append("SQUIRREL")
	word_list.append("GIRAFFE")
	word_list.append("BEAR")
	word_list.append("LIZZARD")
	word_list.append("PINEAPPLE")
